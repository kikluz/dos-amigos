...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<middleman-core>.freeze, ["= 4.5.0"])
    s.add_runtime_dependency(%q<middleman-cli>.freeze, ["= 4.5.0"])
    ...
    s.add_dependency(%q<middleman-core>.freeze, ["= 4.5.0"])
    s.add_dependency(%q<middleman-cli>.freeze, ["= 4.5.0"])
